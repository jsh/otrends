...
Imagine that your happiness is at the mercy of fate.
...
have every day get better? One. One out of 25000! (25,000 factorial).
...
Okay, but what if you relax your criteria a little? Suppose you declare
...
The sequences are random, but we see them as ordered. It's an illusion generated by your brain, like that cloud in the sky shaped like a sheep. <a href="#note4" id="note4ref"><sup>4</sup></a>
> "It's clouds' illusions I recall, I really don't know clouds at all." -- Joni Mitchell

On average, how many trends will we see in a random sequence of 25,000 reals?
...
of 25000 reals, each of which forms a single, downward trend. <a href="#note5" id="note5ref"><sup>5</sup></a>

Polyanna that you are, you just see them as upward trends with
...
<a id="note4" href="#note4ref"><sup>4</sup></a> Seeing Things That Aren't There

Gligovich, Thomas "How We Know What Isn't So" [https://www.amazon.com/How-Know-What-Isnt-Fallibility/dp/0029117062]

<a id="note5" href="#note5ref"><sup>5</sup></a> How to find the circular permutation that's a single trend.

I'll show how to generate single, random, downward trends. (A tiny tweak would get you single upward trends instead.)

Any sequence of random reals can be decomposed uniquely into non-overlapping, adjacent, downward trends. The means of these trends increase, monotonically, from left to right.
...
The details, like "unique decomposition" and "rotations not on trend boundaries don't lead to single trends"? I've left them to the reader, but the proofs aren't hard. See the Reference below.

The Python scripts here decompose sequences into trends and rotate them to create a single trend. You can use them to answer the questions you've been asking yourself as you read this README.
